!(function (t, e) {
  ...
  return (function (t) {
    ...
    function (t, e, r) {
      ...
      for (
        var st = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz", ht = 0;
        ht < st.length;
        ht++
      ) {
        var lt = st.charAt(ht);
      ...
      var St = kt,
        ...
        qt = function (t, e, r, a, n) {
          ...
          if (((t = o.value), s)) {
            var h = s.italic;
            ("text" === r || (a && "mathit" === a.font)) && (h = 0),
              (i = new E(t, s.height, s.depth, h, s.skew, s.width, n));
          } else
            "undefined" != typeof console &&
              console.warn(
          ...
          makeOrd: function (t, e, r) {
            ...
            if (l) {
              ...
              if ("boldsymbol" === l || "mathnormal" === l) {
                ...
                c.contains(Bt, i)
                  ? ((d = "Main-Italic"), (f = ["mathit"]))
                  : h
                  ? ((d = Ht[l].fontName), (f = [l]))
                  : ((d = Lt(l, e.fontWeight, e.fontShape)),
              ...
              if (rt.hasOwnProperty(i) && "Typewriter" === d.substr(0, 10)) {
                for (var x = [], v = 0; v < i.length; v++)
                  x.push(qt(i[v], d, n, e, s.concat(f)));
                return Et(x);
              }
            }
            if ("mathord" === r) {
          ...
          if (1 === t.length) {
            ...
            l &&
              ("sizing" === l.type
                ...
                : "styling" === l.type && (h = e.havingStyle(ie[l.style])));
          }
        ...
        for (var a, n = se(t, e, !0), i = [], o = [], s = 0; s < n.length; s++)
          if (
            ...
            for (
              ...
              s++, o.push(n[s]), n[s].hasClass("nobreak") && (h = !0);
            h || (i.push(pe(o, e)), (o = []));
          } else
            n[s].hasClass("newline") &&
              (o.pop(),
              o.length > 0 && (i.push(pe(o, e)), (o = [])),
              i.push(n[s]));
        o.length > 0 && i.push(pe(o, e)),
          r && (((a = pe(se(r, e, !0))).classes = ["tag"]), i.push(a));
      ...
      function ze(t, e, r, a) {
        ...
        n =
          1 === i.length &&
          i[0] instanceof ge &&
          c.contains(["mrow", "mtable"], i[0].type)
            ? i[0]
            : new ve.MathNode("mrow", i);
      ...
      var Ae = function (t) {
        ...
        Ee = function (t, e) {
          ...
          if (a.isStretchy)
            ...
            var u, p;
            "\\vec" === a.label
              ? ((u = Dt.staticSvg("vec", e)), (p = Dt.svgData.vec[1]))
              : (((u = D(
                  (u = Dt.makeOrd(
        ...
        Le = function (t, e) {
          var r = t.isStretchy
              ? Re(t.label)
              : new ve.MathNode("mo", [be(t.label, t.mode)]),
      ...
      Qt({
        ...
        htmlBuilder: function (t, e) {
          ...
          i.classes.push("x-arrow-pad"),
            t.below &&
              ...
              (r = Dt.wrapFragment(ue(t.below, n, e), e)).classes.push(
                "x-arrow-pad"
              ));
          var o,
            s = Oe(t, e),
        ...
        Qt({
          ...
          handler: function (t, e) {
            for (
              var r = t.parser, a = Ft(e[0], "ordgroup").body, n = "", i = 0;
              i < a.length;
              i++
            ) {
        ...
        ir = function (t, e) {
          ...
          return (
            "small" === i.type
              ...
              ? ((m = 1080 * Je[i.size]),
                (l = (Je[i.size] + s) / o),
                (h = (Je[i.size] + s + 0.08) / o),
                ((r = je("sqrtSize" + i.size, h, m, s, e)).style.minWidth =
                  "1.02em"),
                (a = 1 / o))
              : ((h = t + s + 0.08),
                (l = t + s),
                (m = Math.floor(1e3 * t + s) + 80),
                ((r = je("sqrtTall", h, m, s, e)).style.minWidth = "0.742em"),
                (a = 1.056)),
            (r.height = l),
            (r.style.height = h + "em"),
            {
        ...
        Qt({
          ...
          htmlBuilder: function (t, e) {
            ...
            for (
              ...
              n[h].isMiddle
                ? (s = !0)
                : ((i = Math.max(n[h].height, i)),
                  (o = Math.max(n[h].depth, o)));
            if (
              ((i *= e.sizeMultiplier),
              (o *= e.sizeMultiplier),
              (r =
      ...
      function vr(t, e, r) {
        ...
        if ((t.gullet.beginGroup(), t.gullet.macros.set("\\\\", "\\cr"), !s)) {
          ...
          if (null == l) s = 1;
          else if (!(s = parseFloat(l)) || s < 0)
            throw new o("Invalid \\arraystretch: " + l);
        }
        t.gullet.beginGroup();
        var m = [],
          c = [m],
      ...
      var yr = function (t, e) {
          ...
          function y(t) {
            for (var e = 0; e < t.length; ++e)
              e > 0 && (b += 0.25), l.push({ pos: b, isDashed: t[e] });
          }
            ...
            if (!(a >= s)) {
              ...
              for (r = 0; r < n; ++r) {
                ...
                if (V) {
                  ...
                  (V.depth = F.depth),
                    (V.height = F.height),
                    D.push({ type: "elem", elem: V, shift: U });
                }
              }
              (D = Dt.makeVList(
        ...
        kr = function (t, e) {
          ...
          if (t.cols) {
            var o = t.cols,
              ...
              l = 0,
              m = o.length;
            "separator" === o[0].type && ((n += "top "), (l = 1)),
              "separator" === o[o.length - 1].type &&
                ((n += "bottom "), (m -= 1));
            for (var c = l; c < m; c++)
              "align" === o[c].type
                ? ((i += wr[o[c].align]), h && (s += "none "), (h = !0))
                : "separator" === o[c].type &&
                  h &&
          ...
          return (
            ...
            "" !== n &&
              (r = new ve.MathNode("menclose", [r])).setAttribute(
                "notation",
                n.trim()
              ),
            t.arraystretch &&
              t.arraystretch < 1 &&
              (r = new ve.MathNode("mstyle", [r])).setAttribute(
                "scriptlevel",
                "1"
              ),
            r
        ...
        Sr = function (t, e) {
          ...
          for (var u = 0; u < i; ++u) {
            var p = "r",
              d = 0;
            u % 2 == 1 ? (p = "l") : u > 0 && c && (d = 1),
              (a[u] = { type: "align", align: p, pregap: d, postgap: 0 });
          }
      ...
      gr({
        ...
        handler: function (t, e) {
          var r = {
            cols: (Yt(e[0]) ? [e[0]] : Ft(e[0], "ordgroup").body).map(function (
              t
            ) {
              var e = Gt(t).text;
        ...
        gr({
          ...
          props: { numArgs: 1 },
          handler: function (t, e) {
            var r = (Yt(e[0]) ? [e[0]] : Ft(e[0], "ordgroup").body).map(
              function (t) {
                var e = Gt(t).text;
            ...
            if ((a = vr(t.parser, a, "script")).body[0].length > 1)
              throw new o("{subarray} can contain only one column");
            return a;
          },
          htmlBuilder: yr,
      ...
      var Ir = function (t, e) {
        ...
        Rr = function (t, e) {
          ...
          if (
            (t.hasBarLine
              ? (t.barSize
                  ? ((m = Tt(t.barSize, e)),
                    (l = Dt.makeLineSpan("frac-line", e, m)))
                  : (l = Dt.makeLineSpan("frac-line", e)),
                (m = l.height),
                (c = l.height))
              : ((l = null),
                (m = 0),
        ...
        Or = function (t, e) {
          ...
          if (null != t.leftDelim || null != t.rightDelim) {
            var o = [];
            if (null != t.leftDelim) {
              var s = new ve.MathNode("mo", [
                new ve.TextNode(t.leftDelim.replace("\\", "")),
              ]);
              s.setAttribute("fence", "true"), o.push(s);
            }
            if ((o.push(r), null != t.rightDelim)) {
              var h = new ve.MathNode("mo", [
                new ve.TextNode(t.rightDelim.replace("\\", "")),
              ]);
      ...
      var Hr = function (t, e) {
        ...
        i
          ? ((r = i.sup
              ? ue(i.sup, e.havingStyle(n.sup()), e)
              : ue(i.sub, e.havingStyle(n.sub()), e)),
            (a = Ft(i.base, "horizBrace")))
          : (a = Ft(t, "horizBrace"));
        var o,
      ...
      Qt({
        ...
        mathmlBuilder: function (t, e) {
          var r = Re(t.label);
          return new ve.MathNode(t.isOver ? "mover" : "munder", [
            Me(t.base, e),
            r,
          ]);
        },
        ...
        Qt({
          ...
          handler: function (t, e) {
            ...
            return r.settings.isTrusted({ command: "\\href", url: n })
              ? { type: "href", mode: r.mode, href: n, body: ee(a) }
          ...
          mathmlBuilder: function (t, e) {
            var r = Se(t.body, e);
            return (
              r instanceof ge || (r = new ge("mrow", [r])),
      ...
      Qt({
        ...
        handler: function (t, e, r) {
          ...
          if (r[0])
            for (
              var l = Ft(r[0], "raw").string.split(","), m = 0;
              m < l.length;
              m++
            ) {
              var c = l[m].split("=");
        ...
        Qt({
          ...
          htmlBuilder: function (t, e) {
            var r;
            "clap" === t.alignment
              ? ((r = Dt.makeSpan([], [ue(t.body, e)])),
                (r = Dt.makeSpan(["inner"], [r], e)))
              : (r = Dt.makeSpan(["inner"], [ue(t.body, e)]));
      ...
      var Fr = function (t, e, r, a, n, i, o) {
        ...
        Ur = function (t, e) {
          var r,
            ...
            o = Vt(t, "supsub");
          o
            ? ((r = o.sup), (a = o.sub), (n = Ft(o.base, "op")), (i = !0))
            : (n = Ft(t, "op"));
          var s,
            h = e.style,
            l = !1;
          if (
            ...
            if (
              (("\\oiint" !== n.name && "\\oiiint" !== n.name) ||
                ((u = n.name.substr(1)),
                (n.name = "oiint" === u ? "\\iint" : "\\iiint")),
              (s = Dt.makeSymbol(n.name, m, "math", e, [
                "mop",
                "op-symbol",
                l ? "large-op" : "small-op",
              ])),
            ...
            var f = se(n.body, e, !0);
            1 === f.length && f[0] instanceof E
              ? ((s = f[0]).classes[0] = "mop")
              : (s = Dt.makeSpan(["mop"], Dt.tryCombineChars(f), e));
          } else {
            for (var g = [], x = 1; x < n.name.length; x++)
              g.push(Dt.mathsym(n.name[x], n.mode, e));
            s = Dt.makeSpan(["mop"], g, e);
          }
          var v = 0,
            b = 0;
          return (
            (s instanceof E || "\\oiint" === n.name || "\\oiiint" === n.name) &&
              !n.suppressBaseShift &&
      ...
      function _r(t, e, r) {
        for (
          var a = se(t, e, !1), n = e.sizeMultiplier / r.sizeMultiplier, i = 0;
          i < a.length;
          i++
        ) {
      ...
      Qt({
        ...
        mathmlBuilder: function (t, e) {
          for (
            var r = ke(t.body, e.withFont("mathrm")), a = !0, n = 0;
            n < r.length;
            n++
          ) {
            var i = r[n];
            if (i instanceof ve.SpaceNode);
              ...
              switch (i.type) {
                ...
                case "mo":
                  var o = i.children[0];
                  1 === i.children.length && o instanceof ve.TextNode
                    ? (o.text = o.text
                        .replace(/\u2212/, "-")
                        .replace(/\u2217/, "*"))
                    : (a = !1);
          ...
          return t.parentIsSupSub
            ? new ve.MathNode("mo", [h, l])
            : ve.newDocumentFragment([h, l]);
        },
      }),
        te({
          type: "ordgroup",
          htmlBuilder: function (t, e) {
            return t.semisimple
              ? Dt.makeFragment(se(t.body, e, !1))
              : Dt.makeSpan(["mord"], se(t.body, e, !0), e);
          },
          mathmlBuilder: function (t, e) {
        ...
        Qt({
          ...
          mathmlBuilder: function (t, e) {
            var r = t.body,
              a = t.index;
            return a
              ? new ve.MathNode("mroot", [Me(r, e), Me(a, e)])
              : new ve.MathNode("msqrt", [Me(r, e)]);
          },
        });
      var $r = {
        display: w.DISPLAY,
      ...
      te({
        ...
        mathmlBuilder: function (t, e) {
          ...
          n && !!t.sup === n.isOver && ((a = !0), (r = n.isOver)),
            !t.base ||
              ("op" !== t.base.type && "operatorname" !== t.base.type) ||
              (t.base.parentIsSupSub = !0);
          var i,
            o = [Me(t.base, e)];
          if ((t.sub && o.push(Me(t.sub, e)), t.sup && o.push(Me(t.sup, e)), a))
            i = r ? "mover" : "munder";
          else if (t.sub)
            if (t.sup) {
              var s = t.base;
              ...
              i =
                ...
                "op" === h.type &&
                h.limits &&
                (e.style === w.DISPLAY || h.alwaysHandleSupSub)
                  ? "munder"
                  : h &&
                    "operatorname" === h.type &&
                    h.alwaysHandleSupSub &&
                    (h.limits || e.style === w.DISPLAY)
                  ? "munder"
                  : "msub";
            }
          else {
        ...
        te({
          ...
          mathmlBuilder: function (t, e) {
            ...
            return (
              (r =
                "text" === t.mode
                  ? new ve.MathNode("mtext", [a])
                  : /[0-9]/.test(t.text)
                  ? new ve.MathNode("mn", [a])
                  : "\\prime" === t.text
                  ? new ve.MathNode("mo", [a])
                  : new ve.MathNode("mi", [a])),
      ...
      te({
        type: "tag",
        mathmlBuilder: function (t, e) {
          var r = new ve.MathNode("mtable", [
            new ve.MathNode("mtr", [
              Qr(),
              new ve.MathNode("mtd", [Se(t.body, e)]),
              Qr(),
              new ve.MathNode("mtd", [Se(t.tag, e)]),
            ]),
          ]);
        ...
        la = (function () {
          function t(t, e) {
            (this.input = void 0),
              ...
              (this.input = t),
              (this.settings = e),
              (this.tokenRegex = new RegExp(ha, "g")),
              (this.catcodes = { "%": 14 });
          }
          var e = t.prototype;
          return (
      ...
      var fa = function (t, e) {
        ...
        for (r = t.consumeArgs(1)[0]; 1 === r.length && "#" === r[0].text; ) {
          ...
          if ((n++, parseInt(r[0].text) !== n))
            throw new o('Argument number "' + r[0].text + '" out of order');
          r = t.consumeArgs(1)[0];
        }
        ...
        wa = (function () {
          ...
          return (
            ...
            (e.expandOnce = function () {
              ...
              if (r.numArgs)
                for (
                  var n = this.consumeArgs(r.numArgs),
                    i = (a = a.slice()).length - 1;
                  i >= 0;
                  --i
                ) {
                  var s = a[i];
              ...
              if ("string" == typeof r) {
                ...
                if (-1 !== r.indexOf("#"))
                  for (
                    ...
                    ++a;
                for (
                  var i = new la(r, this.settings), o = [], s = i.lex();
                  "EOF" !== s.text;
          ...
          return (
            ...
            (e.handleInfixNodes = function (t) {
              for (var e, r = -1, a = 0; a < t.length; a++) {
                ...
                if (n) {
                  if (-1 !== r)
                    throw new o("only one infix operator per group", n.token);
                  (r = a), (e = n.replaceWith);
                }
              }
              if (-1 !== r && e) {
              ...
              for (;;) {
                ...
                if ("\\limits" === n.text || "\\nolimits" === n.text) {
                  ...
                  if (i) {
                    ...
                    if (!(i = Vt(a, "operatorname")) || !i.alwaysHandleSupSub)
                      throw new o(
                  ...
                  for (this.consume(); "'" === this.fetch().text; )
                    m.push(l), this.consume();
                  "^" === this.fetch().text &&
                    m.push(this.handleSupSubscript("superscript")),
                    (e = { type: "ordgroup", mode: this.mode, body: m });
                }
              }
              return e || r
      ...
      (Ma.endOfExpression = ["}", "\\endgroup", "\\end", "\\right", "&"]),
        (Ma.endOfGroup = { "[": "]", "{": "}", "\\begingroup": "\\endgroup" }),
