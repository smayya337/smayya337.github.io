  ...
  (t.prototype = {
    ...
    liftAboutCard: function () {
      var t = this,
        ...
        e = i(window).height() / 2 - s / 2 + s;
      s + 30 > i(window).height() && (e = s),
        t.$aboutCard.animate({ top: "-=" + e + "px" }, 500, function () {
  ...
  (function (s) {
    ...
    (t.prototype = {
      ...
      filter: function (t) {
        var s;
        "" === t[0]
          ? (this.showAll(), this.showResult(-1))
          : ((s = this.countPosts(t)),
            this.hideAll(),
            this.showResult(s),
            0 < s && this.showPosts(t));
      },
      showResult: function (t) {
        -1 === t
          ...
          : this.$archiveResult
              .html(this.messages.other.replace(/\{n\}/, t))
              .show();
      },
      countPosts: function (t) {
        return s(this.postsDay + "[data-date^=" + t[0] + t[1] + t[2] + "]")
          .length;
      },
    ...
    (t.prototype = {
      ...
      filter: function (t) {
        "" === t
          ...
          : (this.hideAll(),
            this.showPosts(t),
            this.showResult(this.countCategories(t)));
      },
      showResult: function (t) {
        -1 === t
          ? this.$archiveResult.html("").hide()
      ...
      countCategories: function (t) {
        return o(this.posts + "[data-" + this.dataCategory + "*='" + t + "']")
          .length;
      },
      showPosts: function (t) {
        var e = this,
        ...
        0 < e.countCategories(t) &&
          o(s + "[data-" + e.dataParentCategories + "]").length &&
          o(s).each(function () {
            o(this)
              .attr("data-" + e.dataParentCategories)
              .split(",")
              .forEach(function (t) {
  ...
  (function (e) {
    ...
    e(document).ready(function () {
      function t() {
        var t = !0,
          s = null;
        480 < e(window).height() && ((t = !1), (s = { width: 70, height: 70 })),
          e(".fancybox").fancybox({
            maxWidth: 900,
            maxHeight: 800,
            fitToView: !0,
            ...
            helpers: {
              thumbs: s,
              overlay: {
                css: { overflow: "hidden", background: "rgba(0, 0, 0, 0.85)" },
              },
            },
            afterLoad: function () {
              setTimeout(function () {
                e(".fancybox-next > span, .fancybox-prev > span").css(
                  "visibility",
                  "visible"
                );
              }, 400);
  ...
  (function (e) {
    ...
    (t.prototype = {
      ...
      animate: function () {
        ...
        Math.abs(this.lastScrollTop - t) <= this.delta ||
          (t > this.lastScrollTop && t > this.headerHeight
      ...
      resizeImages: function () {
        ...
        this.$images.each(function () {
          (a = n(this)),
            ...
            (i = a.height()) < s &&
              ((o = e / i),
              a.css({ height: s, width: s * o }),
              a.parent().css({ left: "-" + ((s * o) / 2 - t / 2) + "px" })),
            (e = a.width()),
            (i = a.height()),
            e < t &&
              ((o = i / e),
              a.css({ width: t, height: t * o }),
              a.parent().css({ top: "-" + (i / 2 - s / 2) + "px" })),
            s < i && a.parent().css({ top: "-" + (i / 2 - s / 2) + "px" });
        });
      },
    }),
  ...
  (function (e) {
    ...
    (t.prototype = {
      ...
      swipePostBottomBar: function () {
        ...
        this.lastScrollTop > t &&
        (s + this.$postFooter.height() > t + e(window).height() ||
          s < t + this.$header.height())
  ...
  (function (t) {
    ...
    (s.prototype = {
      run: function () {
        ...
        e.$openButton.click(function () {
          ...
          t(document).keyup(function (t) {
            ...
            "INPUT" !== s &&
              "TEXTAREA" !== s &&
              (83 !== t.keyCode || e.$searchModal.is(":visible") || e.open());
          }),
      ...
      showResultsCount: function (t) {
        var s = "";
        t < 1
          ? ((s = this.$resultsCount.data("message-zero")),
            this.$noResults.show())
          : 1 === t
          ? ((s = this.$resultsCount.data("message-one")),
            this.$noResults.hide())
          : 1 < t &&
            ((s = this.$resultsCount.data("message-other").replace(/\{n\}/, t)),
            this.$noResults.hide()),
    ...
    (s.prototype = {
      run: function () {
        ...
        t.$openBtn.click(function () {
          t.$shareOptionsBar.hasClass("opened") ||
            (t.openShareOptions(), t.$closeBtn.show());
        }),
          t.$closeBtn.click(function () {
            t.$shareOptionsBar.hasClass("opened") &&
              (t.closeShareOptions(), t.$closeBtn.hide());
          });
      },
      openShareOptions: function () {
        ...
        t.$shareOptionsBar.hasClass("opened") ||
          ...
          (t.$shareOptionsBar.addClass("processing opened"),
          t.$body.css("overflow", "hidden"),
          setTimeout(function () {
      ...
      closeShareOptions: function () {
        ...
        t.$shareOptionsBar.hasClass("opened") &&
          !this.$shareOptionsBar.hasClass("processing") &&
          (t.$shareOptionsBar.addClass("processing").removeClass("opened"),
          setTimeout(function () {
            t.$shareOptionsBar.removeClass("processing"),
              t.$body.css("overflow", "");
          }, 250));
  ...
  (function (s) {
    ...
    function t() {
      (this.$sidebar = s("#sidebar")),
        ...
        (this.$blog = s(
          ".post-bottom-bar, #header, #main, .post-header-cover"
        )),
        (this.$body = s("body")),
    ...
    (t.prototype = {
      run: function () {
        ...
        this.$openBtn.click(function () {
          ...
          s(window).resize(function () {
            s(window).width() > t.mediumScreenWidth
              ? (t.resetSidebarPosition(), t.resetBlogPosition())
              : t.closeSidebar();
          });
      },
      ...
      swipeSidebarToRight: function () {
        var t = this;
        this.$sidebar.hasClass("pushed") ||
          this.$sidebar.hasClass("processing") ||
      ...
      swipeBlogToRight: function () {
        var t = this;
        this.$blog.hasClass("pushed") ||
          this.$blog.hasClass("processing") ||
      ...
      swipeBlogToLeft: function () {
        var t = this;
        t.$blog.hasClass("pushed") &&
          !this.$blog.hasClass("processing") &&
          (t.$blog.addClass("processing").removeClass("pushed"),
          setTimeout(function () {
            t.$blog.removeClass("processing");
          }, 250));
      },
    ...
    (t.prototype = {
      ...
      filter: function (t) {
        "" === t
          ...
          : (this.hideAll(),
            this.showPosts(t),
            this.showResult(this.countTags(t)));
      },
      showResult: function (t) {
        -1 === t
          ? this.$archiveResult.html("").hide()
      ...
      countTags: function (t) {
        return s(this.posts + "[data-" + this.dataTag + "*='" + t + "']")
          .length;
      },
      showPosts: function (t) {
